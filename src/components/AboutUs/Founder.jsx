  ...
  return (
    <section className="bg-blue-jivhala py-16 text-white">
      <div className="container mx-auto px-4 md:px-16">
        {/* Header Section */}
        <h1 className="font-bebas font-normal text-[28px] md:text-[40px] leading-[100%] tracking-[0%] text-center text-white mb-6 md:mb-8">
          MEET THE FOUNDER
        </h1>
        <p className="font-['Inter'] font-light text-sm md:text-lg w-full md:w-[75%] mx-auto leading-[115%] tracking-[7%] opacity-85 text-justify mb-8 md:mb-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 bg-cream border rounded-md md:pl-10">
          ...
          <div className="md:w-7/12 text-black p-6 md:py-8 md:pr-8 md:pl-0">
            ...
            <p className="text-xs md:text-base leading-relaxed mb-6 text-justify">
        ...
        <footer className="mt-8 md:mt-12">
          <h2 className="py-3 md:py-4 text-lg md:text-2xl">
            A Message from the Founder
          </h2>
          <div className="bg-white p-4 md:p-6 border rounded-md">
            <p className="text-sm md:text-lg italic text-black mb-2 text-justify">
            ...
            <p className="text-xs md:text-base text-black text-right">
              - Adv. Shravani Muthe
            </p>
          </div>
        </footer>
