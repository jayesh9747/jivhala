    ...
    <div className="bg-white text-black flex items-center justify-center w-full">
      ...
      <div className="mx-auto w-full lg:w-9/12">
        ...
        <p className="font-['Inter'] font-light text-[11px] lg:text-[20px] leading-[100%] tracking-[5%] opacity-85 text-center mb-8">
          A world where every girl, irrespective of her circumstances, is valued, 
          supported, and encouraged to achieve her dreams. We believe in the power of 
          education and empowerment to inspire generations and uplift entire communities.
        </p>
        </div>
      </div>
    </div>
