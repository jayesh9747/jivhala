...
const Journey = () => {
  return (
    <div className="bg-blue-jivhala w-full p-8 relative overflow-hidden min-h-screen">
      {/* Title */}
      ...
      <div
        className="absolute top-0 font-bebas left-5 text-[#FB9EBB]  z-20"
        style={{
      ...
      <div
        className="absolute -bottom-[198px] right-8 text-[#FB9EBB] z-20"
        style={{
          fontFamily: "Bebas Neue",
          fontWeight: "400",
          fontSize: "231.22px",
      ...
      <div className="absolute pt-24 pb-20 inset-0 z-0 grid grid-cols-4 grid-rows-4">
        {/* Row 1: [0, 0, 1, 1] */}
      ...
      <div className="grid grid-cols-3 grid-rows-4 gap-4 relative z-10 h-full">
        {/* Row 1: [1, 0, 0] */}
